    ...
    public static void main(String[] args) {
        ...
        if (file.exists() && file.canRead()) {
            try {
                ...
                System.out.println(obj.getSeguidores());*/
        ...
        if (file2.exists() && file2.canRead()) {
            try {
                ...
                for (Empleados empleados : obj2) {
                    ...
                    System.out.println(empleados.getCumple());
                    System.out.println(empleados.getClass());
        ...
        System.out.println(leerURL(sensor1, Primer_sensor.class));

        // SENSOR 2
        System.out.println("-------------------------------------------");
        System.out.println("Sensor 2: ");
        System.out.println(leerURL(sensor2, Segundo_sensor.class));
    }
